;;; arjen-theme.el --- Color theme by awiersma, created 2001-08-27.

;; Copyright (C) 2012 Niels Widger
...
;;; Credits
;;
;; awiersma created the original theme on 2001-08-27.
;;
;;; Code
(deftheme arjen "The arjen color theme")
...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   ;;   `(vc-mode-face . highlight)
     ...
     `(background-color ((t (:background "black" :foreground "black"))))
     `(background-mode ((t (:background "gray" :foreground "gray"))))
     `(border ((t (:background "black" :foreground "black"))))
     `(border-color ((t (:background "black" :foreground "black"))))
     `(cursor ((t (:background "yellow" :foreground "yellow"))))
     `(cursor-color ((t (:background "yellow" :foreground "yellow"))))
     `(foreground-color ((t (:background "White" :foreground "White"))))
     `(mouse ((t (:background "sienna1" :foreground "sienna1"))))
     `(mouse-color ((t (:background "sienna1" :foreground "sienna1"))))
     ...
     `(elscreen-tab-control-face ((t (:background "Gray85" :foreground "black" :underline "black"))))
     `(elscreen-tab-current-screen-face ((t (:background "black" :foreground "white"))))
     `(elscreen-tab-other-screen-face ((t (:background "Gray85" :foreground "black"))))
     ...
     `(font-lock-keyword-face ((t (:foreground "PaleGoldenrod"))))
